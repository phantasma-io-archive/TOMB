...
{
    public class TombLangLexer: Lexer
    {
        ...
        private readonly static string[] _varTypeNames = Enum.GetNames(typeof(VarKind)).Cast<string>().Select(x => x.ToLower()).ToArray();
